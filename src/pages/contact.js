...
const Contacts = () => {
  ...
  return (
    <div className={`bg-kfcRed text-kfcWhite min-h-screen ${theme === 'dark' ? 'dark' : 'light'}`}>
      <Head>
        <title>KFC Contacts</title>
        <meta name="description" content="Contact KFC" />
      ...
      <div className="pt-16 p-4 md:p-8 lg:p-12">
        <h1 className="mt-8 text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Contact Us</h1>
        <p className="text-lg mb-6">
          For inquiries, feedback, or support, please reach out to us through the following contact information:
        </p>
        <ul className="list-disc pl-8 text-lg">
          <li className="mb-2">
            <span className="font-bold">Email:</span> info@kfc.com
          </li>
          <li className="mb-2">
